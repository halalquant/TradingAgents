...
def make_create_place_order_proposal(storage: ProposalStorage):
    @tool
...
def make_edit_place_order_proposal(storage: ProposalStorage):
    @tool
    def edit_place_order_proposal(
        proposal_id: Annotated[str, "The proposal id that needs to be edited"], #str,
        symbol: Annotated[str, "The trading pair symbol, e.g., 'BTC/USDT'"],
        side: Annotated[str, "The order side, either 'Buy' or 'Sell'"], #str="Buy", # Buy, Sell
        order_type: Annotated[str, "The order type, either 'Market' or 'Limit'"], #str="Market", # Market, Limit
        qty: Annotated[float, "The quantity of market unit asset"],# float=None, 
        ...
        return route_to_vendor("edit_place_order_proposal",
                               ...
                               stop_loss,
                               storage)
    return edit_place_order_proposal

def make_create_amend_order_proposal(storage: ProposalStorage):
    @tool
    def create_amend_order_proposal(
        symbol: Annotated[str, "The trading pair symbol, e.g., 'BTC/USDT'"],# str="BTC/USDT", 
        ...
        return route_to_vendor("create_amend_order_proposal",
                               ...
                               stop_loss,
                               storage)
    return create_amend_order_proposal

def make_edit_amend_order_proposal(storage: ProposalStorage):
    @tool
    def edit_amend_order_proposal(
        ...
        return route_to_vendor("edit_amend_order_proposal",
                               ...
                               stop_loss,
                               storage)
    return edit_amend_order_proposal

def make_create_cancel_order_proposal(storage: ProposalStorage):
    @tool
    def create_cancel_order_proposal(
        symbol: Annotated[str, "The trading pair symbol, e.g., 'BTC/USDT'"],#str="BTC/USDT", 
        order_id: Annotated[str, "The order id"]#str=None,
    ):
        """
        ...
        return route_to_vendor("create_cancel_order_proposal",
                               ...
                               order_id,
                               storage)
    return create_cancel_order_proposal

def make_edit_cancel_order_proposal(storage: ProposalStorage):
    @tool
    def edit_cancel_order_proposal(
        ...
        return route_to_vendor("edit_cancel_order_proposal",
                               ...
                               order_id,
                               storage)
    return edit_cancel_order_proposal

def make_delete_proposal(storage: ProposalStorage):
    @tool
    def delete_proposal(
        proposal_id: Annotated[str, "The proposal id that needs to be edited"], #str,
    ):
